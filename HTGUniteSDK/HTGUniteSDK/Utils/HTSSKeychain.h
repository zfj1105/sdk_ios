...
extern NSString *const kHTSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kHTSSKeychainAccountKey;
 ...
 */
extern NSString *const kHTSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kHTSSKeychainClassKey;

/** Item description. */
extern NSString *const kHTSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kHTSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kHTSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kHTSSKeychainWhereKey;
 ...
 */
@interface HTSSKeychain : NSObject
